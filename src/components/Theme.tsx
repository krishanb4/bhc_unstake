...
function Theme() {
  ...
  return (
    <div className="fixed left-[5px] bottom-[5px] duration-100 dark:bg-[#fa8123]  bg-black text-white  border-solid dark:border-white border-black border-2 rounded-lg">
